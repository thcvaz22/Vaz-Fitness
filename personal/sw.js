const CACHE='vaz-personal-v6';
const ASSETS=['./','./index.html','./app-v2.js','./app-v2.css','./training-library-v2.js','./training-library-v2.css','./premium-v3.js','./premium-v3.css','./coach-tools-v4.js','./coach-tools-v4.css','./manifest.webmanifest','./icon.svg'];
