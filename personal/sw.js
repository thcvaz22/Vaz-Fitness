const CACHE='vaz-personal-v5';
const ASSETS=['./','./index.html','./app-v2.js','./app-v2.css','./training-library-v2.js','./training-library-v2.css','./premium-v3.js','./premium-v3.css','./manifest.webmanifest','./icon.svg'];
