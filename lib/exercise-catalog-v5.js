import { EXERCISE_CATALOG as LEGACY_CATALOG } from './exercise-catalog-v4.js';

export const EXERCISE_CATALOG_ADDITIONS=[
...
export const EXERCISE_CATALOG=[...LEGACY_CATALOG,...EXERCISE_CATALOG_ADDITIONS];
export const EXERCISE_CATALOG_VERSION=5;
