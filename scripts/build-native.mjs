...
const files=['index.html','styles.css','app-core.js','app-pt-guides.js','app-ui.js','app-training.js','app-ai.js','app-running.js','app-profile-v2.js','app-integrations.js','manifest.webmanifest','icon.svg','sw.js'];
