...
// White-label build: include membership, approval gate, dynamic branding and refreshed offline cache.
const files=['index.html','styles.css','native-safearea.css','app-core.js','app-pt-guides.js','app-ui.js','app-training.js','app-ai.js','app-running.js','app-profile-v2.js','app-onboarding-v3.js','app-calibration.js','app-calendar.js','app-integrations.js','app-workout-exit.js','app-training-details.js','app-coach-v2.js','app-running-plus.js','app-polish-v2.js','app-membership.js','app-branding.js','app-custom-exercise-media.js','manifest.webmanifest','icon.svg','sw.js'];
