...
Regras: respeite modalidade, objetivo, níveis separados, disponibilidade semanal e tempo por sessão; considere histórico recente, progressão de cargas, esforço, consistência, prontidão, peso/medidas e corrida; evite aumentos bruscos de volume/intensidade; para corrida não aumente simultaneamente distância, pace e intensidade de forma agressiva; para emagrecimento preserve musculação e progressão sustentável; para hipertrofia use volume recuperável e progressão; mantenha exercícios adequados e comuns; se faltarem dados, seja conservador; não faça diagnóstico médico. O personal fará a decisão final e poderá alterar cada exercício antes de liberar.`}
