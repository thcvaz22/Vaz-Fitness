...
(function installUxV9(){
  ...
  function renderCalendarPage(){
    ...
    return `<section class="v9-page v9-calendar-page"><div class="workout-hero"><div><span class="eyebrow">CALENDÁRIO</span><h1>Acompanhe seu ciclo de treino do início ao fim.</h1><p>Aqui você visualiza seus treinos planejados e concluídos, dias de descanso, faltas, treinos extras e remanejamentos. Assim fica mais fácil entender sua rotina, acompanhar sua evolução e saber o que vem pela frente durante todo o ciclo.</p></div></div>${cal?cal.outerHTML:'<div class="card">Calendário indisponível.</div>'}${history}${goals?`<div style="margin-top:18px">${goals.outerHTML}</div>`:''}</section>`;
  }
