...
(()=>{
  ...
  function openExtraWorkoutDialog(){
    ...
    d.querySelector('[data-generate-extra]')?.addEventListener('click',()=>{close();startGeneratedExtra()});
  }
